 ...
 * 
 * 2. 15 ests parametritzats de cada mètode public (3 punts) (3 test, y 15 de cada)
 * 
...
public class Avaluador {
     ...
     * @throws Exception 
     */
    public double mitjanaSiSupera(Estudiant estudiant) throws Exception { //METODO
        double sumaNotes = 0;
     ...
     * @throws Exception 
     */
    public double mitjana(Estudiant estudiant) throws Exception { //METODO
        double sumaNotes = 0;
     ...
     */
    public Estudiant millorEstudiantPerNotaMitjana(Estudiant[] estudiants) { //METODO //POSIBLE ERROR
